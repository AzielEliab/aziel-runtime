...
function citeJson(origin) {
  ...
  return {
    ...
    identity_note:
      "Aziel Eliab only. Aziel Elroi Eliab is SEO alternateName only. Shared Person @id / person_id is https://www.azieleliab.com/#aziel. Identity machine files (person.jsonld, who-is, well-known) are hub-owned on azieleliab.com — this Worker cites those URLs and does not serve or proxy a second Person document.",
