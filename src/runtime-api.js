...
| GET | \`/v1/mesh\` | QNM rollup: enabled?, bearers, live_nodes (living downloaded Softwares instances), software_nodes ({slug}-worker fan-out). Suite-presence ON by default. Never enables extra radios. Downloads are not live. |
