...
export const RUNTIME_VERSION = "1.6.5";
...
description: >-
  ...
  install, and counted /download stay complete human software. 1.6.5 adds
  ...
  return {
    ...
    "/v1/skill": {
      get: {
        ...
        summary: "Skill markdown: 1.6.5 adds AZMail (APP 1.0) via FragGate only. Honest about 1.1.0 / 1.2.0 / 1.3.0 / 1.4.0 / 1.4.1 / 1.5.0 / 1.6.0 / 1.6.1 / 1.6.2 / 1.6.3 / 1.6.4 / 1.6.5.",
        tags: ["runtime"],
