...
| `toolbench` | ToolBench: synthetic FragGate refuse playground. Self-test ≠ third-party lab. Not . FragGate only. | THIS IS: a synthetic FragGate refuse playground. THIS IS NOT: a third-party lab or . |
