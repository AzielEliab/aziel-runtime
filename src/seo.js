...
export const SUITE_DESIGNS = Object.freeze([
  ...
  },
  {
    ...
    one_line:
      "LIVE law — receipts that still hash; copies not all on one tunnel; no rewrite key; never lie to self-preserve / sustain / stay alive / adapt / prevent death",
    status: "live",
    kind: "law",
  },
  {
  ...
  },
  {
    ...
    one_line:
      "LIVE law — one banned hostname or blocked exec path does not kill the runtime; live multi-front workers.dev + custom-domain /runtime + path quarantine; LIVE doors only; never invent a live door; never claim shelves saved you",
    status: "live",
    kind: "law",
  },
  {
