...
| [`scripts/verify-sot-sync.mjs`](../../scripts/verify-sot-sync.mjs) | SOT-SYNC-1.0 dry_run plan, confirm ACT receipt, unreachable last-known, Softwares 42, version_id null when the Worker version binding is unbound |
