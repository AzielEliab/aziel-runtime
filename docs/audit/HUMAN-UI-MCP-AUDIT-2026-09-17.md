...
Honest completeness. **Never ``.** Softwares stay separate. FragGate stays THE door. AZVPN `auto_use` stays. Mesh overrides ON (operator). Identity Aziel Eliab only.
...
| Item | Why it stays |
| --- | --- |
| ToolBench `` | `FG-STUB`. Self-test ≠ third-party lab. |
