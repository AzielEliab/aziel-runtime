...
export const RUNTIME_VERSION = "1.6.4";
...
export const VERSION_HISTORY = [
  { version: "1.6.4", status: "current", note: "Add PeaceLock (PL-WP-0.1) as a true in-process engine: chosen silence / chosen inaction receipts, hash-chained lattice, HARD_DUTY refuse, ABSENT transcript/counterfactual/motive. FragGate LIVE_OPS open/seal/break/show/verify/stamp/upload_envelope. 28 catalog slugs. 1.6.3 remains KV-backed API use trackers (GET /v1/uses)." },
...
description: >-
  ...
  install, and counted /download stay complete human software. 1.6.4 adds
  ...
  return {
    ...
    "/v1/skill": {
      get: {
        ...
        summary: "Skill markdown: 1.6.4 adds PeaceLock. Honest about 1.1.0 / 1.2.0 / 1.3.0 / 1.4.0 / 1.4.1 / 1.5.0 / 1.6.0 / 1.6.1 / 1.6.2 / 1.6.3 / 1.6.4.",
        tags: ["runtime"],
