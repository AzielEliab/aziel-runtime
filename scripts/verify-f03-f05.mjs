...
assert.equal(requestLimitKind("/v1/mesh/site-presence", "POST"), "mesh_mutate");
assert.equal(requestLimitKind("/v1/mesh/site-heartbeat", "POST"), "mesh_mutate");
assert.equal(requestLimitKind("/v1/mesh/site-presence", "GET"), null);
