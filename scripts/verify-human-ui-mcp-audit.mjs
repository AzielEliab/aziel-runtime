 ...
 * Does not invent scores or claim fielded_100.
...
assert.equal(suitePack.mesh.live_nodes_plane, "instance");
...
assert.match(suitePack.mesh.live_nodes_note, /living downloaded Softwares instances/i);
