...
export const LIVE_OPS = {
  ...
  godlock: ["score", "submit", "health", "skill", "doctor"],
  "aziel-corpus": [
    "search",
    "example",
    "skill",
  ...
  codelock: ["render", "gate-status", "health", "skill", "doctor"],
  ...
  zkattest: ["health", "skill", "doctor", "commit", "attest", "open", "verify", "limitation"],
  mmconsensus: ["health", "skill", "doctor", "tally", "agree", "limitation"],
  toolbench: ["health", "skill", "doctor", "suite", "run_case", "limitation"],
  azvpn: [
    "health",
    "skill",
    "doctor",
