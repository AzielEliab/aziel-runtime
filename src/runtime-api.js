...
| GET | \`/download\` | One-click suite pack JSON (REAL catalog + FoldLock tip + mesh cite). Worker wasm / WireGuard / OpenVPN SLOT. Counted when USES is bound. Aliases: \`/v1/download\`, \`/v1/suite/download\`. Not fielded_100. Not exec. |
