...
const CATALOG = [
  ...
  { slug: "azbrowser", keys: ["azbrowser", "aznet", "browser", "ethical search", "lamb lens", "navigate", "tab"], op: "ethical_search", banner: "not Chromium; FragGate only; no invented visit results" },
