...
const TITLE_OVERRIDES = {
  ...
  "spectrallock:overlay": "Preview a SpectralLock overlay (inject ON/OFF; leftover-bytes recover is not this door)",
  "spectrallock:modes": "List SpectralLock overlay modes (unredact locate/lift/recover/refuse honesty, not a door op)",
  ...
  "spectrallock:doctor": "Check liveness of SpectralLock (leftover-bytes honesty; no unredact door)",
