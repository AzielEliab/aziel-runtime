...
const CATALOG = [
  ...
  { slug: "4dmap", keys: ["4dmap", "4d map", "inspection", "card_pin", "card_walk", "four axis", "inspection frame", "frame_status"], op: "card_new", banner: "not a sequential gate; not a truth score; not an extra door" },
];
