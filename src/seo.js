...
export const SUITE_DESIGNS = Object.freeze([
  ...
  },
  {
    ...
    one_line:
      "LIVE law — three layers: live multi-front ↔ cold shelves; live-node API SLOT; Cap-7 cite + AZNet verify LIVE (hosted exec SLOT; shuffle ping→land); AKM belief_is_not_truth; never invent a live door",
    status: "live",
    kind: "law",
  },
  {
