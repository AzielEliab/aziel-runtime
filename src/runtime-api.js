...
export const VERSION_HISTORY = [
  { version: "1.7.5", status: "current", note: "Softwares capability wave 1: enrich health/skill (axes/neighbors/ops table) and add domain-true doctor/verify/import_export (or window/gates/schema/targets) on decisiongate, forgereceipts, temporallock, staticclock, chronolock, trajectorylock, spectrallock. Catalog one_line capability-forward. LIVE_OPS + catalog ops + engine *_OPS agree. Suite checklist at docs/audit/SUITE-CAPABILITY-CHECKLIST.md. AKM-TRIAD-1.0 stays LIVE fabric (POST /v1/memory/*, MCP memory_*; not Softwares-tab). 4DMap 1.7.4 inspection-frame ops stay. Mesh stays default-off. EmbryoLock/AZChat stay stubs. Identity Aziel Eliab only." },
