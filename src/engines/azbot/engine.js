...
const CATALOG = [
  { slug: "vibelock", keys: ["audio", "wav", "speech", "deepfake", "liveness", "mic", "mp3", "mp4", "physics", "linguistics", "vibration", "vibrations"], op: "analyze", banner: "advisory on posted features or limited PCM; mp4 and mp3 container decode stays on the local package; no accuracy number" },
