...
const TITLE_OVERRIDES = {
  ...
  "azmail:mail_post": "Post local AZMail",
  ...
  "azmail:transport_status": "Read AZMail transport status (no public MTA)",
  ...
  "spectrallock:overlay": "Preview a SpectralLock overlay (inject ON/OFF; leftover-bytes / recover / handwriting are not this door)",
  "spectrallock:modes": "List SpectralLock overlay modes (unredact + recover + handwriting honesty, not door ops)",
  "spectrallock:targets": "List SpectralLock overlay targets",
  "spectrallock:verify": "Verify a SpectralLock overlay hash (not leftover-bytes recover)",
  "spectrallock:doctor": "Check liveness of SpectralLock (leftover-bytes + revision-graph honesty; no unredact/recover/handwriting door)",
