...
SRC = ROOT / "docs/designs/ACT-RECEIPT-1.0.md"
OUT = ROOT / "docs/designs/ACT-RECEIPT-1.0.pdf"
...
def page_stream(lines, page_no, pages):
    ...
    cmds.append("(%s) Tj" % escape("ACT-RECEIPT-1.0  ·  Aziel Eliab only  ·  page %d / %d" % (page_no, pages)))
    cmds.append("ET")
    return "\n".join(cmds)
