...
export const ROLE_NOTE =
  "Admin is the node owner. Developer may post, pull, roll up, publish ref updates, claim .aziel names, witness a claim, vouch, publish an advisory, quarantine a peer locally, switch island mode, and submit remote-task receipts for their own handle. Guest may pull their own inbox. The runtime does not keep a role table. Registration, rollup, ref update, name record, witness, vouch, advisory, quarantine, island, delivery, and remote-task receipts must be signed by the handle's key. One handle cannot act as another. Private keys stay on the node.";
