...
| SLOT | `fielded_100`, `live_remote_harness`, `invent_pass`, `third_party_lab` |
| OUT OF SCOPE | Inventing a fielded-100 score, a third-party lab letter, or a remote harness. |
