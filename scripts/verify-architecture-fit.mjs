...
assert.equal(classifyCall(buildRegistry(PRODUCTS).bySlug.toolbench, "invent_completeness").kind, "stub");
...
const tbStub = await (await post("/v1/fraggate/call", { slug: "toolbench", op: "invent_completeness" })).json();
