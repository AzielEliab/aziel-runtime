...
const PRODUCTS_RAW = [
  ...
  },
  {
    ...
    ops: [
      ...
      { op: "limitation", method: "GET", summary: "Honesty labels: REAL door classification; SLOT for fielded-100." },
    ],
  ...
  const paths = {
    ...
    "/download": {
      get: {
        ...
        summary:
          "One-click suite pack JSON. REAL: Softwares catalog, FragGate registry summary, FoldLock tip cite, mesh/nine-laws/VPN cites, About Aziel. SLOT: Worker wasm, WireGuard/OpenVPN/L3, qnm-node bytes. Counted when USES is bound. Not fielded_100. Not exec.",
        tags: ["software"],
