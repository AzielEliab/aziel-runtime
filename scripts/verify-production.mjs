/**
 * 1.4.1 production gates (kept in 1.6.0 / 1.6.1): ready, token, rate-limit, receipt cap, TTL, HEAD, no-store.
 * Author: Aziel Eliab.
 */
...
assert.equal(authoritySnapshot().version, "1.6.1");
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.1" && row.status === "current"));
