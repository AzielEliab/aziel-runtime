...
export const SUITE_DESIGNS = Object.freeze([
  ...
  },
  {
    ...
    one_line:
      "LIVE law — mutual backup: live multi-front ↔ cold shelves; one banned door is not last tip gone; one dead shelf is not last door gone; live-node API SLOT; never invent a live door",
    status: "live",
    kind: "law",
  },
  {
