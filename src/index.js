...
const CATALOG_CHANGELOG_20 =
  "2.0.0-rc1 is the certification-point freeze (not a feature dump): public contract, compatibility, receipt schema, refusal contract, and breaking-change policy under docs/2.0/. Clean-room reproducibility + external adversarial pack for independent reviewers (self-test ≠ third-party lab). No intentional behavioral breaks from 1.9.3. Remain-OFF untouched. FragGate remains THE single door. New engines deferred to 2.1+. Crawler abstract stays lead copy. Identity Aziel Eliab only.";
...
${homepageAddUrlHtml(origin)}
  ...
  <div class="honesty">
    ...
    <ul>
      <li><strong>2.0.0-rc1</strong> is the certification-point freeze (not a feature dump). Public contract, compatibility, receipt schema, refusal contract, and breaking-change policy live under <code>docs/2.0/</code>. Clean-room reproducibility + external adversarial pack for independent reviewers (self-test ≠ third-party lab). No intentional behavioral breaks from 1.9.3. Remain-OFF untouched. FragGate remains THE single door. New engines deferred to 2.1+. Crawler abstract stays lead copy. Identity Aziel Eliab only.</li>
