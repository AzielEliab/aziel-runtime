...
- `GET /survival` (BAN-SURVIVAL-1.0 mutual backup: live multi-front ↔ these shelves; not a sixth shelf; shelves back up death-by-ban; SPORE-1.0 last-resort failsafe — does not replace these shelves)
