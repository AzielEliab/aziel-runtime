...
1. **Call the Softwares tool.** The door runs first. ChainLock, TemporalLock, and ForgeReceipts stamp when the call needs a ledger. \`confirm=true\` writes. \`dry_run=true\` previews and writes nothing. \`background=true\` returns Running until a receipt hash exists.
