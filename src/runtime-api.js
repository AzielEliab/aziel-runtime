  ...
  return {
    ...
    "/v1/mesh": {
      get: {
        ...
        summary:
          "QNM-BUILD-1.0 suite rollup (enabled?, bearers, live/locked/isolated). Read-only suite-presence ON by default. GET never enables radios beyond that. Not a login mesh. Views/MCP/downloads do not enter QNM-S. Packet-transfer coding design is QNS-CD-1.0 (photon QNS1 1.3 on local qnsd; GET /v1/qns cites only).",
        tags: ["mesh"],
