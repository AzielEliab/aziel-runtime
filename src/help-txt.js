...
export function helpGlamaTxt(origin) {
  ...
  return [
    ...
    "",
    `Worker remote: POST ${base}/mcp`,
    `Live Worker: POST ${GLAMA_REMOTE_MCP}`,
    ...
    "",
    "MCP tools/list is 36 live tools.",
    "",
    `Install / Try on Glama: ${RUNTIME_GLAMA}`,
    ...
    "## First call",
    "",
    "@aziel-runtime → fraggate_list → fraggate_describe → fraggate_call.",
