...
function assertDurability(block, label, env) {
  ...
  assert.doesNotMatch(JSON.stringify(block), /OAuth|doi:|framagit|fielded-100/i, `${label} no invented claims`);
...
assert.doesNotMatch(wrangler, /OAuth|doi:|framagit|fielded-100/i);
