...
assert.doesNotMatch(home, /data-domain-tab="elroi"/);
...
assert.match(home, /id="first-hour"/);
assert.match(home, /id="first-hour-title"/);
assert.match(home, /Show me around/);
assert.match(home, /data-tour="next"/);
assert.match(home, /data-tour="done"/);
assert.match(home, /Nothing below is removed/);
assert.match(home, /not a top-bar tab/);
assert.match(home, /id="desk-hint-softwares"/);
assert.match(home, /id="desk-hint-fraggate"/);
assert.match(home, /id="desk-hint-interface"/);
assert.match(home, /id="desk-hint-mesh"/);
assert.match(home, /id="desk-hint-receipts"/);
assert.match(home, /id="azai-coach"/);
assert.match(home, /id="desk-mcp"/);
assert.match(home, /Pick a Software card\. FragGate only\./);
...
assert.doesNotMatch(ws, /data-domain-tab="elroi"/);
assert.match(ws, /id="sot-desk"/);
assert.doesNotMatch(ws, /data-domain-tab="corpus"/);
assert.match(ws, /id="first-hour"/);
assert.match(ws, /id="jeeves-coach"/);
assert.match(ws, /Start with a suggested question/);
assert.match(ws, /id="desk-azai"/);
assert.match(ws, /id="dash-receipts"/);
assert.match(ws, /id="desk-mcp"/);
assert.match(ws, /software_tab/);
assert.match(ws, /<section class="first-hour" id="first-hour"/);
assert.doesNotMatch(ws, /id="first-hour"[^>]*hidden/);
