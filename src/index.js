/**
 * aziel-runtime 1.6.10 — FragGate door + AZHub + AZInterface + AZNet + AZBrowser + AZMail + PeaceLock + KV-backed API use trackers.
 *
 ...
 * GET  /v1/runtime.json       machine manifest: role=engine-runtime (1.6.10), door=fraggate
...
async function combinedOpenApi(request, env) {
  ...
  return {
    ...
    info: {
      ...
      description:
        "1.6.10 sets AZBrowser / AZNet catalog one_line to separate software (not engine). Same FragGate door. Two catalog slugs stay. " +
