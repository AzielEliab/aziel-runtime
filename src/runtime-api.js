...
**1.7.4 = 4DMap inspection-frame capability bump.** LIVE_OPS add frame_status, axis_describe, walk_trace, card_export, card_import, verify_chain, neighbor_cite. Stubs stay. Not a sequential gate and not an extra door.
...
| POST | \`/v1/mesh/disable\` | Refused (\`MESH-DISABLE-REFUSED\`). Public mesh-off is removed. |
  ...
  return {
    ...
    "/v1/mesh/disable": {
      post: {
        ...
        summary: "Refused (MESH-DISABLE-REFUSED). Read-only suite-presence stays ON. Public mesh-off is removed.",
        tags: ["mesh"],
