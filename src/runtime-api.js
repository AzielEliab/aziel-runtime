  ...
  return {
    ...
    "/mcp": {
      ...
      post: {
        ...
        summary:
          "JSON-RPC MCP-over-HTTP. tools/list is the live tool set (~36). Pipeline: fraggate_list → fraggate_describe → fraggate_call. Echoes Mcp-Session-Id and MCP-Protocol-Version. Preferred protocolVersion 2025-11-25 (still accepts 2025-06-18 and 2025-03-26). Invalid protocol is HTTP 400. Mutating tools require confirm=true or dry_run=true. Refuse exist.mcp points here. Proxy /p/{slug}/{op} is not exec. FragGate remains THE single door.",
        tags: ["fraggate"],
        requestBody: {
          required: true,
          content: {
