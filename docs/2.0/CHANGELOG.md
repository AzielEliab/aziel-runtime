...
- Additive Worker-launch hard rule (not a new public MCP tool): every launch surface includes product-specific `#hashtag` parts plus the shared About Aziel + FoldLock corpus tip. See [`docs/WORKER-LAUNCH.md`](../WORKER-LAUNCH.md).
