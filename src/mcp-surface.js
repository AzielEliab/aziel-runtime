...
export function mcpInitializeInstructions() {
  return (
    ...
    "Fabric MCP names mesh_* chainlock_* memory_* decisiongate_check library_lookup are kernel-direct wrappers (same kernels FragGate mesh/memory/chainlock use). Not MASTER-33. Not a second Softwares door. Softwares exec stays fraggate_call only. " +
