...
export function addendumTxt(origin) {
  ...
  return [
    ...
    "## Glama",
    "",
    `Primary MCP listing: ${RUNTIME_GLAMA}`,
    "Glama Install Server talks to this Worker /mcp. Same FragGate door as Cursor and Claude.",
    "",
...
export function helpGlamaTxt(origin) {
  ...
  return [
    ...
    "## Install",
    "",
    "Glama is the primary public host. Install Server uses glama.json + Dockerfile (stdio MCP that bridges to this Worker /mcp).",
    "On Cursor / Claude Desktop: add an MCP server pointing at POST /mcp.",
    "On ChatGPT GPT Actions / Grok / Venice: import OpenAPI 3.1.",
    "",
    "## After connect",
    "",
    "1. tools/list shows the thin FragGate door.",
    "2. fraggate_list then fraggate_describe then fraggate_call.",
    "3. Softwares cards (one_line) live at GET /v1/software.",
    "",
    "Compatible clients: ChatGPT, Grok, Venice, Claude, Cursor, Glama, Perplexity, Copilot, Gemini, Mistral, Meta AI, Apple Intelligence, Amazon Q, DuckAssist, You.com, Cohere, plus other MCP/OpenAPI-capable assistants.",
    "",
    `Help index: ${base}/help.txt`,
