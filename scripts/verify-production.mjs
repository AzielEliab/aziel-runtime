...
// --- helpers ---
assert.equal(RUNTIME_VERSION, "1.7.10");
...
assert.equal(authoritySnapshot().version, "1.7.10");
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.10" && row.status === "current"));
