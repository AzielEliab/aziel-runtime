...
export const ENGINE_RUNNERS = {
  ...
  spectrallock: { ops: SPECTRALLOCK_OPS, run: runSpectrallock, source: "vendored SpectralLock 0.3.1 overlay.js (256px PNG preview; wheel paint separate from triad; pigment and restore-pigment are FragGate doors; unredact/recover/handwriting stay in the artifact)", module: "src/engines/spectrallock.js" },
  ...
  azinterface: { ops: AZINTERFACE_OPS, run: runAzinterface, source: "AZInterface AIH-WP-1.0 suite shell and custodial page cycles (package 0.1.0; local pipeline_arch/withdraw/scorch_local/pair_* stay off the public door; FragGate only)", module: "src/engines/azinterface.js" },
  ...
  "4dmap": { ops: FOURDMAP_OPS, run: runFourdmap, source: "4DMap 4DM-WP-1.0 / 0.3.0 four-axis inspection frame T/Δ/Γ/Π (inspection frame after AZPIPE; library pin lattice; not an extra door; not a sequential gate)", module: "src/engines/4dmap.js" },
  ...
  toolbench: { ops: TOOLBENCH_OPS, run: runToolbench, source: "ToolBench TOOLBENCH-0.1 synthetic FragGate refuse playground (self-test ≠ third-party lab; not )", module: "src/engines/toolbench.js" },
