 ...
 * GET  /v1/runtime.json       machine manifest: role=engine-runtime (1.7.4), door=fraggate
...
async function combinedOpenApi(request, env) {
  ...
  return {
    ...
    info: {
      ...
      description:
        "1.7.4 syncs 4DMap LIVE_OPS with product 0.2.0 (pin/span/stack/gap/fork/walk/lens/class/cohort/absence/cap/join/list/example plus frame_status/axis_describe/walk_trace/card_export/card_import/verify_chain/neighbor_cite; inspection frame, not an extra door). " +
        ...
        "1.6.14 adds 4DMap (4DM-WP-1.0) as a true in-process engine: four-axis inspection frame T/Δ/Γ/Π after AZPIPE — not a sequential gate and not an extra door. Call only via POST /v1/fraggate/call (or MCP fraggate_call) with { slug: \"4dmap\", op }. 1.7.4 LIVE_OPS sync product 0.2.0 verbs (pin/span/stack/gap/fork/walk/lens/class/cohort/absence/cap/join/list/example) plus frame_status/axis_describe/walk_trace/card_export/card_import/verify_chain/neighbor_cite. truth_score/lumen_panel/invent_mark/backdate_class stay stub. FragGate claims cite join types. " +
