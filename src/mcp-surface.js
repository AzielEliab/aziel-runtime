...
export function mcpInitializeInstructions(env = {}) {
  ...
  return (
    ...
    "Call the Softwares tool. The door runs before the tool. Callers do not start with a door tool or with chainlock_append. " +
