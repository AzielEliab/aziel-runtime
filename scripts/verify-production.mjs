...
// --- helpers ---
assert.equal(RUNTIME_VERSION, "1.7.11");
...
assert.equal(authoritySnapshot().version, "1.7.11");
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.11" && row.status === "current"));
