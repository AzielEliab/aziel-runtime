...
function llmsTxt(origin) {
  ...
  const lines = [
    ...
    `Mesh: ${base}/v1/mesh  (QNM-BUILD-1.0 suite rollup. Read-only suite-presence is ON by default. GET /v1/mesh never enables radios beyond that. Public mesh-off is refused. Not a login mesh. Not Node Gate.)`,
...
async function combinedOpenApi(request, env) {
  ...
  return {
    ...
    tags: [
      ...
      { name: "mesh", description: "QNM-BUILD-1.0 suite rollup. Read-only suite-presence ON by default. live/locked/isolated counts. Public mesh-off is refused. Not a login mesh. Not a Softwares-tab product." },
