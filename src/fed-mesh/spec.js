...
export const ROLES = Object.freeze({
  admin: Object.freeze({
    name: "Admin",
    is: "node owner",
    may: Object.freeze(["register", "heartbeat", "leave", "post", "pull", "deliver", "rollup", "peers", "bootstrap", "multisig-policy", "remote-task", "direct", "ref", "sync", "object"]),
  }),
  developer: Object.freeze({
    name: "Developer",
    is: "builder on this node",
    may: Object.freeze(["post", "pull", "deliver", "rollup", "remote-task", "direct", "ref", "sync", "object"]),
  }),
  guest: Object.freeze({
    name: "Guest",
