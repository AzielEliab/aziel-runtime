/**
 * 1.4.1 production gates (kept through 1.7.0): ready, token, rate-limit, receipt cap, TTL, HEAD, no-store.
 * Author: Aziel Eliab.
 */
...
assert.equal(authoritySnapshot().version, "1.9.1");
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.9.1" && row.status === "current"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.9.0" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.11" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.10" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.8" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.7" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.6" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.5" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.4" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.7.3" && row.status === "superseded"));
...
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.14" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.13" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.12" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.11" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.9" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.8" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.6" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.5" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.4" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.3" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.2" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.1" && row.status === "superseded"));
assert.ok(VERSION_HISTORY.some((row) => row.version === "1.6.0" && row.status === "superseded"));
